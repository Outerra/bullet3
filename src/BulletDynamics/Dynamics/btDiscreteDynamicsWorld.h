...
public:
	...
	virtual bool addCollisionObject(btCollisionObject * collisionObject, int collisionFilterGroup = btBroadphaseProxy::StaticFilter, int collisionFilterMask = btBroadphaseProxy::AllFilter ^ btBroadphaseProxy::StaticFilter);

	virtual bool	addRigidBody(btRigidBody* body);

	virtual bool addRigidBody(btRigidBody * body, int group, int mask);
